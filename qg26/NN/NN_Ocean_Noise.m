...
net = network;
net.numInputs = 1;  % Number of Inputs. Already been set to 3.
net.numLayers = 4;
...
net.inputs{1}.exampleInput = zeros(240000, 1);   % "2" should be changed to the dimention of our input
...
net.layers{4}.size = 64; % the value on right-hand side should be equal to the dimention of outputs
net.layers{4}.transferFcn = 'purelin';
net.layers{4}.initFcn = 'initwb';

net.outputs{4}.exampleOutput = zeros(64, 1); % right-hand side is for telling Matlab the dimension of outputs
...
%,'plotconfusion','plotroc','ploterrcorr','ploterrhist','plotfit','plotinerrcorr'};
