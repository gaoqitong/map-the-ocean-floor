...
close all; % Close all figure windows except those created by imtool. imtool close all; 
% Close all figure windows created by imtool. workspace; % Make sure the workspace panel is showing.
fontSize = 16;
axis on;
letsGo = 1;
while letsGo
...
if strcmpi(button, 'Cancel') clf;
close all;
imtool close all end
end
% Save the data
