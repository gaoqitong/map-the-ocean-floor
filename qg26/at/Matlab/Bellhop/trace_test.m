function [ h, hLayer, hTop, hBot, h4, h5 , xBotreturn , tBotreturn , ...
    nBotreturn , I1, rayreturn, IsegBot, IsegTop, DistBegTop, DistEndTop, DistBegBot , DistEndBot  ] = ...
    trace_test( SSP, deltas, xs, alpha, Amp0, BeamType, Box, RunType )
...
for I = 1 : MaxSteps
    ...
    [ h, hLayer, hTop, hBot, h4, h5 , ray( I1 ).x, ray( I1 ).Tray, ray( I1 ).p, ray( I1 ).q, ray( I1 ).tau, ray( I1 ).Rfa, ray( I1 ).c ] = ...
        step_test( SSP, ray( I0 ).x, ray( I0 ).Tray, ray( I0 ).p, ray( I0 ).q, ray( I0 ).tau, ray( I0 ).Rfa, ...
