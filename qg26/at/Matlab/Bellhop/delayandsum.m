function delayandsum(name,source,sample_rate)
...
% clearvars -except name source sample_rate

v  = [ 2, 0 ];   % Receiver motion vector (vr, vz ) in m/s
v  = [ 0, 0 ];   % Receiver motion vector (vr, vz ) in m/s
c0 = 1500;       % reference speed to convert v to proportional Dopplepr
