...
f0=2500;                 % baseband bandwidth is 2*f0
w0=pi2*f0;
...
Yc=-100;                 % Cross-range distance to center of target area
Y0=30;                   % Target area in cross-range is within [-Y0,Y0]
                         % Using Yc, targe area in cross-range within
                         % [Yc-Y0,Yc+Y0]
%
