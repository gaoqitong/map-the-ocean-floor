function  [ TitleEnv, freq, SSP, Bdry, Pos, Beam, cInt, RMax, fid ] = read_env( envfil, model, drift)
...
[ TitleEnv, freq, SSP, Bdry, fid ] = read_env_core_drift( envfil, drift);    % read in the environmental file
